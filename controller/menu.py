...
def gerar_relatorio():
    ...
    mes_str = pedir_mes()
    try:
        nome_arquivo, df = gerar_relatorio_mensal(mes_str, REPORTS_DIR)
        if df.empty:
